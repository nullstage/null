...
const buildLines = (): string[] => [
  "……또 하나가 눈을 떴군.",
  "여기는 NULL. 이름을 잃은 자들이 마지막으로 흘러드는 곳이다.",
  "붉은 달이 지지 않는 한, 이 폐허를 벗어나는 길은 하나뿐이지.",
  "네 손에 들린 검과 총 — 그것이 네가 살아온 방식을 말해 줄 것이다.",
  "나는 기록한다. 네가 어떻게 싸우고, 무엇을 고르고, 어디서 쓰러지는지.",
  "기록이 쌓이면, 이곳도 너를 알게 된다. ……그때부터가 진짜 시험이다.",
  "저 끝의 게이트가 열려 있다. 준비가 되면, 걸어 들어와라.",
];
