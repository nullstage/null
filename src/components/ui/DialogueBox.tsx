...
const buildLines = (): string[] => [
  "……또 하나가 눈을 떴군.",
  "여기는 NULL. 그림자에 침식당해, 이름부터 잃어버린 세계의 끝이다.",
  "저 붉은 달 아래를 떠도는 것들은 한때 전부 사람이었다.",
  "그림자는 먼저 이름을 삼키고, 그다음에 몸을 삼킨다. …너도 반쯤은 잊었을 테지.",
  "놈들이 흘리는 조각은 삼켜진 자들의 마지막 기억이다. 거둬 두어라 — 탐내는 자가 있으니.",
  "나는 기록한다. 네가 어떻게 싸우고, 무엇을 고르고, 어디서 쓰러지는지.",
  "기록이 쌓이면 침식도 너를 배운다. ……그때부터가 진짜 시험이다.",
  "저 끝의 게이트가 열려 있다. 이름을 되찾고 싶다면, 걸어 들어와라.",
];
